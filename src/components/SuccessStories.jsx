  ...
  return (
    <section className="success-stories-section section-padding">
      <div className="container">
        ...
        >
          <h2 className="section-title" style={{ color: '#fff' }}>Il nostro unico obiettivo:<br/><span className="text-gradient">portarti sul set.</span></h2>
          <p className="section-subtitle" style={{ maxWidth: '800px', margin: '0 auto 3rem auto', color: '#b3b3b3' }}>
        ...
        {/* Recensione Google Statica */}
        <motion.div 
          className="google-review-box glass"
        ...
        >
          <div className="gr-header">
            <div className="gr-author-info">
              <div className="gr-avatar">I</div>
              <div>
                <h5 className="gr-author-name">Ilaria De Donato</h5>
                <div className="gr-stars">
                  ★★★★★ <span className="gr-time">1 anno fa</span>
                </div>
              </div>
            </div>
          ...
          <p className="gr-text">
            "Un'esperienza incredibile. I docenti sono veri professionisti e grazie all'Accademia sono arrivata a lavorare sul set della fiction Mediaset 'Storia di una famiglia perbene' subito dopo gli studi. Consigliatissima!"
          </p>
        </motion.div>
      </div>
    </section>
